...
const Section5 = () => {
  return (
    <div className="lg:px-12 px-5 md:px-8 g:py-20 md:py-1 lg:mt-10 items-center flex flex-col py-8">
      <p className="text-3xl justify-start w-full "><span className="hover:underline w-fit cursor-pointer flex gap-2 items-center">MarketPlace <MdKeyboardArrowRight /></span></p>
